        ...
        <div id="container">
            ...
            <div id="content-container">
                ...
                <div id="content">
					...
					<div class="block01">
						<div class="blockTitle" id="divTitle1">Tìm kiếm theo hàng <c:out value="${model.name}"/> (<c:out value="${fn:length(model.result)}"/> kết quả)</div>
						<div class="contentCenter" id="divContainer1">
							<c:choose>
