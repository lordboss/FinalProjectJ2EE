					...
					<div class="block01">
						...
						<div class="contentCenter" id="newsContainer">
							...
							<spring:nestedPath path="tinTuc">
								<form method="post" action="updateNews.html" onsubmit="return checkForm02();">
									<div class="newsItem">
													...
													<table width="100%" bgcolor="f8f8ff" border="0" cellspacing="0" cellpadding="3">
													    ...
													    <tr>
													    	<spring:bind path="hienThi">
													    		...
													    		<td>
													    			<select name="${status.expression}">
													    				<option value="true" <c:if test="${status.value eq true}">selected</c:if> >Hiển thị</option>
													    				<option value="false" <c:if test="${status.value eq false}">selected</c:if> >Không hiển thị</option>
													    			</select>
													    		</td>
													    		<td>
													    			<c:if test="${status.error}">
