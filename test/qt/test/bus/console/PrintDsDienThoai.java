...
public class PrintDsDienThoai {
	...
	public static void main(String[] args) {
		...
		DienThoaiBUS tBus = (DienThoaiBUS) context.getBean("dienThoaiBUS");
		List<DienThoai> ds = tBus.findAll();
		printDsDienThoai(ds);

		System.out.println("BOOM!!!");
		// findByFuntionality(tBus);
		advancedSearch(tBus);
	}

	public static void findByFuntionality(DienThoaiBUS tBus) {
		...
		List<DienThoai> ds = tBus.findByFunctionality(c);
		printDsDienThoai(ds);
	}

	public static void advancedSearch(DienThoaiBUS tDao) {
